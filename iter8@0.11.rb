class Iter8AT011 < Formula
  ...
  url "https://github.com/iter8-tools/iter8.git",
      tag:      "v0.11.8",
      revision: "7a4621147107115561d2f9fbefd27a31cd49eaba"
  license "Apache-2.0"

  if OS.mac?
    url "https://github.com/iter8-tools/iter8/releases/download/v0.11.8/iter8-darwin-amd64.tar.gz"
    sha256 "0f1fa1c9cce8841b541bfdb5f19d69e6187ba0e39ceee51f417c4252c12ea4f5"
  else
    depends_on "go" => :build
  end
